...
export default function apiReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case types.API_V1_HFKHFJFHK_LIST:
    case types.API_V1_HFKHFJFHK_LIST_SUCCEEDED:
    case types.API_V1_HFKHFJFHK_LIST_FAILED:
    case types.API_V1_HFKHFJFHK_CREATE:
    case types.API_V1_HFKHFJFHK_CREATE_SUCCEEDED:
    case types.API_V1_HFKHFJFHK_CREATE_FAILED:
    case types.API_V1_HFKHFJFHK_READ:
    case types.API_V1_HFKHFJFHK_READ_SUCCEEDED:
    case types.API_V1_HFKHFJFHK_READ_FAILED:
    case types.API_V1_HFKHFJFHK_UPDATE:
    case types.API_V1_HFKHFJFHK_UPDATE_SUCCEEDED:
    case types.API_V1_HFKHFJFHK_UPDATE_FAILED:
    case types.API_V1_HFKHFJFHK_PARTIAL_UPDATE:
    case types.API_V1_HFKHFJFHK_PARTIAL_UPDATE_SUCCEEDED:
    case types.API_V1_HFKHFJFHK_PARTIAL_UPDATE_FAILED:
    case types.API_V1_HFKHFJFHK_DELETE:
    case types.API_V1_HFKHFJFHK_DELETE_SUCCEEDED:
    case types.API_V1_HFKHFJFHK_DELETE_FAILED:
